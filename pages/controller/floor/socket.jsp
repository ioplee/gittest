                    ...
                    <div class="panel__body">
                        ...
                        <div class="ui-table-container">
                            <div class="ui-table-toolbar">
                                <a href="javascript:void(0);" class="ui-button-primary ui-button-sm" title="一键全开" id="floor_socket_open_multi"><i class="fa fa-toggle-on"></i>&nbsp;一键全开</a>
                                <a href="javascript:void(0);" class="ui-button ui-button-sm" title="一键全关" id="floor_socket_close_multi">一键全关&nbsp;<i class="fa fa-toggle-off"></i></a>
                            </div>
                            <table class="ui-table" id="floor_socket_list">
                                <thead>
                                    <tr>
                        ...
                        <div class="ui-table-paging" id="floor_socket_list_paging"></div>
                    </div>
                    <!--// .panel__body -->
                </div>
                <!--// .ui-panel -->
...
var Floor_socket_list = (function(){
    var page_no = 1,
        page_limit = 10,
        page_total = null,
        records_length = null;
    ...
    return {
        init: function(_$table_id, _params){
            ...
            get_resources(page_no, function(_data){
                (!!_data['result'] && _data['result'].length>0) && Paging.init('floor_socket_list_paging', {
                    pageNo:  _data['pageNo'],
...
Floor_socket_list.init('floor_socket_list', {
    page_no: Url('?pageNo') || 1,
    page_limit: Url('?pageSize') || 10
});


$('#floor_socket_open_multi').on('click', function(){
    multi_switch(true, Floor_socket_list.get_select_result());
});
$('#floor_socket_close_multi').on('click', function(){
    multi_switch(false, Floor_socket_list.get_select_result());
});
</script>
