                    ...
                    <div class="panel__body">
                        ...
                        <div class="ui-table-container">
                            <div class="ui-table-toolbar">
                                <a href="javascript:void(0);" class="ui-button-primary ui-button-sm" title="一键全开" id="building_plug_open_multi"><i class="fa fa-toggle-on"></i>&nbsp;一键全开</a>
                                <a href="javascript:void(0);" class="ui-button ui-button-sm" title="一键全关" id="building_plug_close_multi">一键全关&nbsp;<i class="fa fa-toggle-off"></i></a>
                            </div>
                            <table class="ui-table" id="building_plug_list">
                                <thead>
                                    <tr>
                        ...
                        <div class="ui-table-paging" id="building_plug_list_paging"></div>
                    </div>
                    <!--// .panel__body -->
                </div>
                <!--// .ui-panel -->
...
var Building_plug_list = (function(){
    var page_no = 1,
        page_limit = 10,
        page_total = null,
        records_length = null;
    ...
    return {
        init: function(_$table_id, _params){
            ...
            get_resources(page_no, function(_data){
                (!!_data['result'] && _data['result'].length>0) && Paging.init('building_plug_list_paging', {
                    pageNo:  _data['pageNo'],
...
Building_plug_list.init('building_plug_list', {
    page_no: Url('?pageNo') || 1,
    page_limit: Url('?pageSize') || 10
});


$('#building_plug_open_multi').on('click', function(){
    multi_switch(true, Building_plug_list.get_select_result());
});
$('#building_plug_close_multi').on('click', function(){
    multi_switch(false, Building_plug_list.get_select_result());
})
