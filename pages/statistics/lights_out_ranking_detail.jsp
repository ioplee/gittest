...
<head>
    ...
    <title>综合报表-班级熄灯排名报表-报表明细</title>
            ...
            <div class="body-content__wrapper">
                <div class="ui-panel">
                    <div class="panel__header">
                        ...
                        <span class="panel-title"><i class="fa fa-list"></i>&nbsp;班级熄灯报表明细</span>
                    </div>
                            ...
                            <table class="ui-table" id="lights_out_ranking">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:180px">超时时长（分钟）</th>
                                        <th>开灯时间</th>
                                        <th>熄灯时间</th>
                                        <th>寝室</th>
                                    </tr>
...
var LightsOut_ranking_detail = (function(){
    var page_no = 1,
        page_limit = 10,
        page_total = null,
        records_length = null;
    ...
    function get_resources(_page_next, _class_no, _success_callback){
        ...
        get_resources_handler = $.getJSON('/school/V1/report/_lightsOutViewPage', resource_params).done(function(_data, _status, _xhr){
        ...
        $.each(_result, function(__index, __item){
            tpl.push([
                '<tr class="'+ ((__index>0 && (__index%2)) ? 'ui-table-split' : '') +'">',
                    ...
                    '<td>'+ __item['beginDate'] +'</td>',
                    '<td>'+ __item['endDate'] +'</td>',
...
LightsOut_ranking_detail.init('lights_out_ranking', {
...
$('#back_to_list').on('click', function(){
    var list_path = Url('?list_path') || null,
        history_back_url = (list_path!==null && list_path.length!==0) ? window.decodeURIComponent(list_path) : '/school/route/statistics/lightsOutRankingMore';
