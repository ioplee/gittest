            ...
            <div class="body-content__wrapper">
                <div class="ui-panel">
                    <div class="panel__header">
                        <span class="panel-title"><i class="fa fa-list"></i>&nbsp;班级能耗排名报表</span>
                    </div>
...
var Electric_ranking = (function(){
    ...
    function get_resources(_page_next, _begin_date, _end_date, _order, _success_callback){
        ...
        get_resources_handler = $.getJSON('/school/V1/report/_energyPage', resource_params).done(function(_data, _status, _xhr){
        ...
        $.each(_result, function(__index, __item){
            tpl.push([
                '<tr class="'+ ((__index>0 && (__index%2)) ? 'ui-table-split' : '') +'">',
                    ...
                    '<td>'+ __item['power'] +'</td>',
                    '<td>',
                        '<a href="/school/route/statistics/ElectricRankingMoreDetail?class_no='+ __item['class_no'] +'&list_path='+ window.encodeURIComponent(Url())+'" class="ui-button ui-button-xs" title="查看明细"><i class="fa fa-th"></i>&nbsp;查看明细</a>',
                    '</td>',
                '</tr>',
            ].join(''));
        });
