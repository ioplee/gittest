...
<head>
    ...
    <title>综合报表-班级考勤排名报表-报表明细</title>
    ...
    <div class="body-container">
        ...
        <div class="body-container__main">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-split">/</span>
                <span class="breadcrumb-active">班级考勤排名报表</span>
                <span class="breadcrumb-split">/</span>
            ...
            <div class="body-content__wrapper">
                <div class="ui-panel">
                    <div class="panel__header">
                        ...
                        <span class="panel-title"><i class="fa fa-list"></i>&nbsp;班级考勤报表明细</span>
                    </div>
...
var Attendence_ranking = (function(){
    ...
    function get_resources(_page_next, _class_no, _success_callback){
        ...
        get_resources_handler = $.getJSON('/school/V1/report/_attendanceViewPage', resource_params).done(function(_data, _status, _xhr){
...
$('#back_to_list').on('click', function(){
    var list_path = Url('?list_path') || null,
        history_back_url = (list_path!==null && list_path.length!==0) ? window.decodeURIComponent(list_path) : '/school/route/statistics/attendenceRankingMore';
