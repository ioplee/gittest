    ...
    <div class="body-container">
        ...
        <div class="body-container__main">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-split">/</span>
                <span class="breadcrumb-active">班级寝室评分报表</span>
            </div>

            <div class="body-content__wrapper">
                <div class="ui-panel">
                    <div class="panel__header">
                        <span class="panel-title"><i class="fa fa-list"></i>&nbsp;班级寝室评分报表</span>
                    </div>
...
var Grade_ranking = (function(){
    ...
    function get_resources(_page_next, _begin_date, _end_date, _class_name, _success_callback){
        ...
        get_resources_handler = $.getJSON('/school/V1/report/_appraisalPage', resource_params).done(function(_data, _status, _xhr){
        ...
        $.each(_result, function(__index, __item){
            tpl.push([
                '<tr class="'+ ((__index>0 && (__index%2)) ? 'ui-table-split' : '') +'">',
                    ...
                    '<td>',
                        '<a href="/school/route/statistics/gradeRankingMoreDetail?class_no='+ __item['class_no'] +'&list_path='+ window.encodeURIComponent(Url())+'" class="ui-button ui-button-xs" title="查看明细"><i class="fa fa-th"></i>&nbsp;查看明细</a>',
                    '</td>',
                '</tr>',
            ].join(''));
        });
